    ...
    public partial class addPurchaseTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LineID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FormResponseISBN = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasketLineItem_FormResponses_FormResponseISBN",
                        column: x => x.FormResponseISBN,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketLineItem_FormResponseISBN",
                table: "BasketLineItem",
                column: "FormResponseISBN");
